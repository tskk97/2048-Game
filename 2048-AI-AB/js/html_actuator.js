...
HTMLActuator.prototype.actuate = function (grid, metadata) {
  ...
  window.requestAnimationFrame(function () {
    ...
    self.updateScore(metadata.score, metadata.moves);
...
HTMLActuator.prototype.updateScore = function (score, moves) {
...
HTMLActuator.prototype.message = function (won) {
  ...
  var message = won ? "Congratulations! You have reached 2048" : "Sorry! You have no moves left";
